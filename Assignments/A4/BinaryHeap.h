...
private:
  ...
  // allocated array
  //              maintaining the relative order of the elements and the array
  //              is returned
...
public:
  ...
  // Heap. Postcondition: The Binary Heap remains unchanged. Time Efficiency:
  // O(1)
  unsigned int getElementCount() const;

  // Description: Inserts newElement into the Binary Heap according to its heap
  // properties.
  ...
  // Postcondition: The root element is removed, and the Binary Heap's heap
  // properties are restored. Exceptions: Throws EmptyDataCollectionException if
  // the Binary Heap is empty. Time Efficiency: O(log n)
  void remove();

  // Description: Retrieves (but does not remove) the necessary element.
  // Precondition: This Binary Heap is not empty.
  // Postcondition: This Binary Heap is unchanged.
  // Exceptions: Throws EmptyDataCollectionException if this Binary Heap is
